# 논리 연산자
# 논리 연산자는 피연산자의 논리 자료형(Tree/False)을 이용하는 연산자로 and, or, not이 있습니다.
...
# or 연산자
# or은 '또는' 이라는 뜻으로, 피연산자 중에서 하나라도 True라면 결과값은 True가 된다.

# var1 = True
# var2 = False
# print(var1 or var2)         #True
# print(f'var1 or var2: { var1 | var2 }')  
...
# not(부정) 연산자
# not은 '부정'이란 뜻으로, 피연산자의 현재 상태를 부정하는 연산자입니다.
...
# reslut = (num1 < num3) and (num2 <num3)    #True
# print(f'reslut: {reslut}')

# num1 = 10; num2=20; num3 =30
# reslut = (num1 > num3) and (num2 <num3)    #False
# print(f'reslut: {reslut}')
...
# and, or 연산시 주의사항
# and 연산자는 모든 피연산자가 True인 경우에만 결과를 Trus로 출력하기 때문에
# 첫 번째 연산의 결과가 False이면 더 이상 연산을 실행하지 않습니다.

# num1 = 10; num2 = 20 
# result = (num1 < 15) and (num2 > 15)       # True

# num1 = 17; num2 = 20
# result = (num1 < 15) and (num2 > 15)       # False

# or연산자는 피연산자 중 하나라도 True가 있다면 결과값은
# True이기 때문에 True 피연산자를 만나게 되면 이후 피연산자의 연산은 무시하고 무조건 True를 출력한다.
